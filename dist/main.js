...
___CSS_LOADER_EXPORT___.push([module.id, "@import url(https://fonts.googleapis.com/css2?family=Lato:wght@400;700&family=Lemon&family=Poppins:wght@400;600&family=Oxygen+Mono&display=swap);"]);
// Module
...
/* harmony import */ var _conditions_json__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./conditions.json */ "./src/modules/conditions.json");
...
function formatDate(dateGiven) {
	...
	let formattedDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(newDate, 'EEEE-MMMM dd, yyyy').split('-');
	return { dayOfWeek: formattedDate[0], date: formattedDate[1] };
}
function setTheme(themeCode) {
	let condObj = _conditions_json__WEBPACK_IMPORTED_MODULE_0__.find(
